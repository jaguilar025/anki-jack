      ...
      <div className="min-h-screen bg-black p-4">
        <div className="max-w-md mx-auto">
          <div className="flex items-center justify-between mb-6">
            ...
            <Button className="bg-gray-300" onClick={resetCamera} size="sm">
              Nueva Captura
            </Button>
          </div>
          ...
          <Card>
            <CardContent className="p-6 bg-black rounded-lg">
              ...
              <Image
                    ...
                    />
                <div className="text-gray-400">Strokes: {kanjiResult.strokes}</div>
              </div>
                ...
                <div className="my-6">
                  ...
                  <div className="space-y-2">
                    {kanjiResult.vocabulary.map((word, index) => (
                      <div key={index} className="bg-black border border-gray-500 p-3 rounded-lg">
